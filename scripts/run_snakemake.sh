...
snakemake -p processed/Homo_sapiens.GRCh38.96_log.txt --cluster ./snakemake_submit_UT.py --jobs 200 --config fill=TRUE start_end_diff=25 cage=../data/CAGE_promoter_annotations_25bp_290420.rds --use-singularity
