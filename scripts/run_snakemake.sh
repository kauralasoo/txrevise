...
snakemake -s cage.Snakefile --cluster ./snakemake_submit_UT.py --jobs 100 --config annotation=Homo_sapiens.GRCh38.96 fill=TRUE start_end_diff=25 --use-singularity
