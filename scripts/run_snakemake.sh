...
snakemake -ps cage.Snakefile processed/Homo_sapiens.GRCh38.96.gtf.gz --cluster ./snakemake_submit_UT.py --jobs 100 --config fill=TRUE start_end_diff=25 --use-singularity
