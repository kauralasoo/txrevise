...
Each run of constructEvents.R produces up to six output files: alternative promoter, internal exon and 3' end events 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTA0OTc3NjI2MCwtMTQwNzEyNzcxNSwxNj
